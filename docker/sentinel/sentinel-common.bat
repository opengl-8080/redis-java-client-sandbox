...
set INSTANCE_NAME_BASE=redis-instance
set MASTER_CONTAINER_NAME=%INSTANCE_NAME_BASE%1
set SLAVE1_CONTAINER_NAME=%INSTANCE_NAME_BASE%2
set SLAVE2_CONTAINER_NAME=%INSTANCE_NAME_BASE%3

set SENTINEL_CONTAINER_NAME_BASE=redis-sentinel
set SENTINEL1_CONTAINER_NAME=%SENTINEL_CONTAINER_NAME_BASE%1
set SENTINEL2_CONTAINER_NAME=%SENTINEL_CONTAINER_NAME_BASE%2
set SENTINEL3_CONTAINER_NAME=%SENTINEL_CONTAINER_NAME_BASE%3
set SENTINEL4_CONTAINER_NAME=%SENTINEL_CONTAINER_NAME_BASE%4
...
set SENTINEL4_DIR=%SENTINEL_DIR%\%SENTINEL4_CONTAINER_NAME%
...
set SENTINEL4_PATH=%SENTINEL_PATH%/%SENTINEL4_CONTAINER_NAME%
